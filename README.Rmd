...
extdata_path <- "https://github.com/openwashdata/sdghhsurveymw/raw/main/inst/extdata/"
...
The dataset `sdghhsurveymw` contains
`r nrow(sdghhsurveymw)` observations and `r ncol(sdghhsurveymw)`
variables
...
readr::read_csv("data-raw/dictionary.csv") |>
  dplyr::filter(file_name == "sdghhsurveymw.rda") |>
